...
- `.deepx/skills/dx-agent-stream-build-pipeline/SKILL.md` for templates
...
The skill document (`.deepx/skills/dx-agent-stream-build-pipeline/SKILL.md`) contains complete
