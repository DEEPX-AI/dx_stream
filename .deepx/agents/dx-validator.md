...
Reference: `.deepx/skills/dx-agent-stream-validate/SKILL.md` for property validation details.
...
2. .deepx/skills/dx-agent-stream-validate/SKILL.md  (validation reference)
