...
Invoke this skill BEFORE any pipeline build task. This includes `/dx-agent-stream-build-pipeline`
and `/dx-agent-stream-build-mqtt-kafka`. Skip only if the user explicitly says "just build it".
