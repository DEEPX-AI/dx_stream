...
void Classification(const std::vector<dxs::DXTensor>& outputs, DXFrameMeta* frame_meta,
    ...
    frame_meta->_label = label;
    frame_meta->_label_confidence = confidence;
    if (label >= 0 && label < static_cast<int>(params.classNames.size())) {
        frame_meta->_label_name = params.classNames[label];
    }
}
...
DX_CUSTOM_EXPORT void PostProcess(GstBuffer* buf,
    ...
    Classification(network_output, frame_meta, params);
}