...
launch_cmd="gst-launch-1.0 -e ${src_pipe} ${inference_pipe} ${compositor_pipe} compositor name=comp ${compositor_props} ! $VIDEOCONVERT_PIPELINE ! fpsdisplaysink $VIDEO_SINK_ARGS"
echo "--------------------------------------------------"
