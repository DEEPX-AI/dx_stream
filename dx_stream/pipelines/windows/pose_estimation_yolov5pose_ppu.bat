@echo off
setlocal
title DX-Stream Pose Estimation (YOLOV5Pose PPU)
...
set "MODEL=%MODEL_DIR%/YOLOV5Pose_PPU.dxnn"
...
echo ============================================================
echo  DX-Stream Pose Estimation (YOLOV5Pose PPU)
echo ============================================================
echo  Model : %MODEL%
echo  Video : %VIDEO%
echo ============================================================
...
gst-launch-1.0 ^
    ...
    ! queue max-size-buffers=1 ^
    ! dxpostprocess inference-id=1 library-file-path="%LIB%" function-name=YOLOV5Pose_PPU ^
    ! dxosd ^
    ! videoconvert ^
