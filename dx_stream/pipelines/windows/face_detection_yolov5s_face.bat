@echo off
setlocal
title DX-Stream Face Detection (YOLOv5s_Face)
...
set "MODEL=%MODEL_DIR%/yolov5-s-face_640x640.dxnn"
set "LIB=%LIB_DIR%/postprocess_yolov5s_face.dll"
set "VIDEO=%VIDEO_DIR%/dance-group.mov"

if not "%~1"=="" set "VIDEO=%~1"

echo ============================================================
echo  DX-Stream Face Detection (YOLOv5s_Face)
echo ============================================================
echo  Model : %MODEL%
echo  Video : %VIDEO%
echo ============================================================
