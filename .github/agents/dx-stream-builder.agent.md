...
description: Build GStreamer pipeline applications for real-time video processing on DEEPX NPU. Detection, tracking, segmentation,
  multi-stream, RTSP, and broker integration.
...
- label: Build Pipeline
  ...
  prompt: Build a GStreamer dx_stream pipeline application.
  send: false
- label: Manage Models
...
<!-- Source: .deepx/agents/dx-stream-builder.md -->
...
3. Read `.github/skills/dx-agentic-stream-build-pipeline.md` (if building pipeline)
