---
name: dx-agentic-stream-build-mqtt-kafka
description: Build MQTT/Kafka broker application
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agentic-stream-build-mqtt-kafka/SKILL.md -->
...
Invoke with `/dx-agentic-stream-build-mqtt-kafka` or ask the dx-stream-builder agent
