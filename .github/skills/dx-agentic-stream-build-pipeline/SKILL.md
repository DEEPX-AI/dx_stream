---
name: dx-agentic-stream-build-pipeline
description: Build GStreamer pipeline application for dx_stream
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agentic-stream-build-pipeline/SKILL.md -->
...
Invoke with `/dx-agentic-stream-build-pipeline` or ask the dx-stream-builder agent.
