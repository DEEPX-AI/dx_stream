---
name: dx-agentic-stream-validate
description: Pipeline validation for dx_stream
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agentic-stream-validate/SKILL.md -->
...
Invoke with `/dx-agentic-stream-validate` to run pipeline validation. Can be used standalone
or as part of the `/dx-agentic-runtime-validate` feedback loop.
...
# 5. Path resolution in run_<app>.sh (dx-agentic-dev context)
#    Verify that SRC_DIR actually contains samples/models/
#    CRITICAL: dx-agentic-dev scripts are 2 levels below dx_stream root,
...
| "No such file" in run script | Wrong SRC_DIR path | Use dx-agentic-dev path template (pitfall #13) |
