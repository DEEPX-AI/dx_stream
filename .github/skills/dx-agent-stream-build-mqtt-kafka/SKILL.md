---
name: dx-agent-stream-build-mqtt-kafka
description: Build MQTT/Kafka broker application
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agent-stream-build-mqtt-kafka/SKILL.md -->
...
All AI-generated broker pipeline applications MUST be created under `dx-agent-dev/`,
NOT in production directories. This prevents accidental modification of existing pipelines.

### Session Directory

```
dx-agent-dev/<YYYYMMDD-HHMMSS>_<model>_broker/
...
Invoke with `/dx-agent-stream-build-mqtt-kafka` or ask the dx-stream-builder agent
