---
name: dx-agentic-stream-model-management
description: Model management for dx_stream pipelines
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agentic-stream-model-management/SKILL.md -->
...
Invoke with `/dx-agentic-stream-model-management` or ask the dx-model-manager agent directly.
