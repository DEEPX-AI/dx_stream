...
GST_START_TEST(test_element_initialization) {
    GstElement *element = gst_element_factory_make("dxrouter", NULL);
    fail_unless(element != NULL, "Failed to create GstDxRouter element");
...
Suite *dxrouter_suite(void) {
    Suite *s = suite_create("GstDxRouter");
