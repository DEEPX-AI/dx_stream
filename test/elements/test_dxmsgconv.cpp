...
GST_START_TEST(test_element_initialization) {
    GstElement *element = gst_element_factory_make("dxmsgconv", NULL);
...
Suite *dxmsgconv_suite(void) {
    Suite *s = suite_create("GstDxMsgConv");
