...
OUTPUT=$(
    ...
    out.src_0 ! dxosd ! dxscale width=640 height=360 ! comp.sink_0 \
    out.src_1 ! dxosd ! dxscale width=640 height=360 ! comp.sink_1 \
    out.src_2 ! dxosd ! dxscale width=640 height=360 ! comp.sink_2 \
    out.src_3 ! dxosd ! dxscale width=640 height=360 ! comp.sink_3 \
    compositor name=comp \
    sink_0::xpos=0 sink_0::ypos=0 \
    sink_1::xpos=640 sink_1::ypos=0 \
    sink_2::xpos=0 sink_2::ypos=360 \
