...
| 명령어 | 설명 |
|---------|------|
| /dx-agentic-stream-build-pipeline | GStreamer 파이프라인 앱 빌드 (6개 카테고리: single-model, multi-model, cascaded, tiled, parallel, broker) |
| /dx-agentic-stream-build-mqtt-kafka | MQTT/Kafka message broker 파이프라인 앱 빌드 |
